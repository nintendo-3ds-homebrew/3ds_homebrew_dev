...
int main(int argc, char **argv)
{
	...
	while (aptMainLoop())
	{
		...
		printf("\x1b[15;19HHello World!\r");
		printf("\x1b[0;0H");
		printf("Roses are \x1b[31mred\x1b[0m\n\r");
		printf("Violets are \x1b[34mblue\x1b[0m\r");
		printf("Piracy is bad\n\r");
		printf("While homebrews are good\n\r");
		printf("\x1b[47;30mBlack text on white background\x1b[0m\r");


		printf("\x1b[29;15HPress Start to exit.\r");
